...
class CLAY_RscRadioButton
{
	...
	borderSize = 0;
	colorText[] = {1,1,1,1};
	colorDisabled[] = {0.75,0.75,0.75,0.5};
...
class CLAY_RscRadioLB_C
{
	...
	colorSelectBackground[] = {0.5,0.5,0.5,0.5};
	colorText[] = {1,1,1,1};
	...
	sizeEx = 0.025;
	rowHeight = 0.04;
	soundSelect[] = {"\ca\ui\data\sound\onclick",0.07,1}; //{"",0.1,1};
	soundExpand[] = {"",0.1,1};
	soundCollapse[] = {"",0.1,1};
	maxHistoryDelay = 10;
	autoScrollSpeed = -1;
...
class CLAY_CarRadio_RadioDlg
{
	...
	controls[] = {CLAY_RADIO_ButtonVolUp, CLAY_RADIO_ButtonVolDown, CLAY_RADIO_ButtonPlayPause, 
		CLAY_RADIO_TextTime, CLAY_RADIO_ShowTime, CLAY_RADIO_TextVol, CLAY_RADIO_ShowVol, CLAY_RADIO_TextStat, CLAY_RADIO_TextMainTitle, CLAY_RADIO_TextMusicSource, CLAY_RADIO_TextRepeat, CLAY_RADIO_TextRandom, CLAY_RADIO_TextDisplayColor, 
		CLAY_RADIO_ButtonPre, CLAY_RADIO_ButtonNext, CLAY_RADIO_ButtonSourceUp, CLAY_RADIO_ButtonSourceDown, CLAY_RADIO_ButtonOff, CLAY_RADIO_ButtonPlaylist, CLAY_RADIO_ButtonRepeatSelect, CLAY_RADIO_ButtonRandomSelect, 
		/* CLAY_RADIO_ButtonKeyColorSelect, CLAY_RADIO_ButtonBackgroundColorSelect, */
		CLAY_RADIO_ButtonDisplayColorSelect
		};
	...
	class CLAY_RADIO_ButtonVolUp: CLAY_RscRadioButton
	{
		idc = 603;
		text = "+";
		action = "['volUp'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.125;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonVolDown: CLAY_RscRadioButton
	{
		idc = 604;
		text = "-";
		action = "['volDown'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.125;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayPause: CLAY_RscRadioButton
	{
		idc = 626;
		text = ">";
		action = "['play'] execVM 'addons\CLAY_CarRadio\scripts\controls.sqf'";
		x = 0.125;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPre: CLAY_RscRadioButton
	{
		idc = 615;
		text = "<<";
		action = "['pre'] execVM 'addons\CLAY_CarRadio\scripts\controls.sqf'";
		x = 0.77;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonNext: CLAY_RscRadioButton
	{
		idc = 616;
		text = ">>";
		action = "['next', 1] execVM 'addons\CLAY_CarRadio\scripts\controls.sqf'";
		x = 0.83;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceUp: CLAY_RscRadioButton
	{
		idc = 617;
		text = "/\";
		action = "['sourceUp'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.8;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceDown: CLAY_RscRadioButton
	{
		idc = 618;
		text = "\/";
		action = "['sourceDown'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.8;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayList: CLAY_RscRadioButton
	{
		idc = 620;
		text = "Playlist";
		action = "[] execVM 'addons\CLAY_CarRadio\scripts\playlist.sqf'";
		x = 0.21;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRepeatSelect: CLAY_RscRadioButton
	{
		idc = 621;
		text = "Repeat";
		action = "['playRepeat'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.3;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRandomSelect: CLAY_RscRadioButton
	{
		idc = 622;
		text = "Random";
		action = "['playRandom'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.39;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
/*
	class CLAY_RADIO_ButtonKeyColorSelect: CLAY_RscRadioButton
	{
		idc = 623;
		text = "Key Col";
		action = "['kCol'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.48;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
*/
	...
	class CLAY_RADIO_ButtonDisplayColorSelect: CLAY_RscRadioButton
	{
		idc = 624;
		text = "Dspl Col";
		action = "['dCol'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.57;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
/*
	class CLAY_RADIO_ButtonBackgroundColorSelect: CLAY_RscRadioButton
	{
		idc = 625;
		text = "Design";
		action = "['Color'] execVM 'addons\CLAY_CarRadio\scripts\settings.sqf'";
		x = 0.66;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
class CLAY_CarRadio_PlaylistDlg
{
	...
	controlsBackground[] = {
		CLAY_RADIO_PlaylistBgd,
		CLAY_RADIO_PlaylistTitle
		};
	...
	controls[] = {
		CLAY_RADIO_ListPlaylistTracks, 
		CLAY_RADIO_ListAllTracks, 
		CLAY_RADIO_ButtonAddSingle, 
		CLAY_RADIO_ButtonAddAll, 
		CLAY_RADIO_ButtonRemoveSingle, 
		CLAY_RADIO_ButtonRemoveAll, 
		CLAY_RADIO_ButtonOK, 
		CLAY_RADIO_ButtonCancel, 
		CLAY_RADIO_ButtonRestore
		};
	class CLAY_RADIO_ListPlaylistTracks: CLAY_RscRadioListbox
	{
		...
		w = 0.3;
		h = 0.65;
		onLBDrop = "nul = _this execVM 'addons\CLAY_CarRadio\scripts\lbdrop.sqf'";
	};
	...
	class CLAY_RADIO_ButtonAddSingle: CLAY_RscRadioButton
	{
		idc = 634;
		text = "<";
		action = "['addSingle'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.48;
		y = 0.4;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonAddAll: CLAY_RscRadioButton
	{
		idc = 635;
		text = "<<";
		action = "['addAll'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.48;
		y = 0.51;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveSingle: CLAY_RscRadioButton
	{
		idc = 636;
		text = ">";
		action = "['removeSingle'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.48;
		y = 0.45;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveAll: CLAY_RscRadioButton
	{
		idc = 637;
		text = ">>";
		action = "['removeAll'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.48;
		y = 0.56;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonOK: CLAY_RscRadioButton
	{
		idc = 638;
		text = "OK";
		action = "['create'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.45;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonCancel: CLAY_RscRadioButton
	{
		idc = 639;
		text = "Cancel";
		action = "[] spawn {closeDialog 0; sleep 0.1; [] execVM 'addons\CLAY_CarRadio\scripts\radio.sqf'};";
		x = 0.575;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRestore: CLAY_RscRadioButton
	{
		idc = 640;
		text = "Restore";
		action = "['restore'] execVM 'addons\CLAY_CarRadio\scripts\editor.sqf'";
		x = 0.325;
		y = 0.825;
		w = 0.1;
		h = 0.05;
