		...
		*/
		...
		switch (CLAY_RadioSrc) do
		{
			case 1:
			{
				...
				["play"] execVM "addons\CLAY_CarRadio\scripts\controls.sqf";
			};
			case 2:
			{
...
*/
	case "dCol":
	{
		...
		{
			[] execVM "addons\CLAY_CarRadio\scripts\display.sqf";
