...
["kCol"] execVM "addons\CLAY_CarRadio\scripts\settings.sqf";

CLAY_RadioDisplay = CLAY_RadioDisplay - 1;
["dCol"] execVM "addons\CLAY_CarRadio\scripts\settings.sqf";
...
["volUp"] execVM "addons\CLAY_CarRadio\scripts\settings.sqf";
